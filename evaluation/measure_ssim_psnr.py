"""
# This code is borrowed from https://github.com/xahidbuffon/FUnIE-GAN
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-data", default="../infer_result", type=str, metavar="PATH",
                        help="path to images (default: none)")
    parser.add_argument("--label-data", default="../../mix/trainB", type=str, metavar="PATH",
